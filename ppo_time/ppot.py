...
class PPOT(OnPolicyAlgorithm):
    """
    Proximal Policy Optimization algorithm (PPOT) (clip version)
    Paper: https://arxiv.org/abs/1707.06347
    Code: This implementation borrows code from OpenAI Spinning Up (https://github.com/openai/spinningup/)
    https://github.com/ikostrikov/pytorch-a2c-ppo-acktr-gail and
    and Stable Baselines (PPOT2 from https://github.com/hill-a/stable-baselines)
    Introduction to PPOT: https://spinningup.openai.com/en/latest/algorithms/ppo.html
    ...
    def learn(
        ...
        tb_log_name: str = "PPOT",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> "PPOT":

        return super(PPOT, self).learn(
