...
class HPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        rgamma: float = 0.0,
        vs_gamma: float = 1.0,
        reweight_scheme: str="SPCL_linear_vsgammaxstdloss"
    ):
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                pl_std = np.std(pl_losses_for_average)
                ...
                elif self.reweight_scheme == "SPCL_linear_vsgammaxstdloss":
                    v = -1.0 / self.vs_gamma *pl_std * loss_diff + 1
                    v = np.maximum(np.minimum(v, 1), 0)
